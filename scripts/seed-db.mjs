...
const db = new Database(
    resolve(process.env.SQLITE_DB_PATH || "./data/scolarite.sqlite")
);
...
const seed = db.transaction(() => {
    ...
    r.run(gs.get("20260001").id, rt, "2026-2027"); r.run(gs.get("20260002").id, rt, "2026-2027"); r.run(gs.get("20260003").id, mmi, "2026-2027"); r.run(gs.get("20260004").id, mmi, "2026-2027"); r.run(gs.get("20260005").id, iot, "2026-2027");
}); seed(); console.log("Données de démonstration insérées."); db.close();